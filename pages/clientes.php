...
<body class="container-xxl px-0 vh-100 d-flex flex-column">
    ...
    <main class="flex-grow-1 overflow-y-auto p-3 p-md-4">
        ...
        <section class="container-fluid mb-4" aria-labelledby="titulo-buscador">
            ...
            <h2 id="titulo-buscador" class="visually-hidden">Búsqueda y acciones de clientes</h2>
            ...
            <div class="d-flex gap-3">
                ...
                <div class="input-group">
                    ...
                    <input 
                        ...
                        placeholder="Buscar por nombre del negocio, contacto  o correo..." 
        ...
        <!--
        Inicio Contenedor principal de la tabla de clientes esta visual sera despues de pantallas de medida md
        ...
        <div class="table-responsive d-none d-md-block" aria-labelledby="titulo-tabla">
            ...
            -->
            <h2 id="titulo-tabla" class="visually-hidden">Listado de clientes en formato tabla</h2>
        ...
        <!--
        Fin Contenedor principal de la tabla de clientes esta visual sera despues de pantallas de medida md
        para pantallas menores se manejan card que estan despues de esta seccion
        -->


        <!-- Inicio contenedor de la lista de clientes esta visual sera antes de pantallas de medida md-->
        ...
        <section class="d-md-none jafr-grid-cards" aria-labelledby="titulo-tarjetas">
            ...
            <!--
                ...
                Pero para el tema de accesibilidad si sera tenido en cuenta
            -->
            <h2 id="titulo-tarjetas" class="visually-hidden">Listado de clientes en formato tarjeta</h2>
        ...
        <!-- Fin contenedor de la lista de clientes esta visual sera antes de pantallas de medida md-->
    ...
    <nav class="offcanvas offcanvas-end rounded-4" tabindex="-1" id="menuLateral" aria-labelledby="etiquetaMenuLateral" style = "max-height: 620px; width:270px">
        ...
        <div class="offcanvas-body overflow-y-auto">
            ...
            <div class="d-flex flex-column gap-4 px-3 mt-3">
                ...
                <a href="clientes.php" class="d-flex align-items-center link-secondary fw-bold fs-5">
